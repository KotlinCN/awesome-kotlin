...
*欢迎访问这个由俄罗斯人提供的搜索器：* http://kotlin.link/[http://kotlin.link/]
...
* http://kotlinlang.org/docs/reference/[官网教程^] 
* http://kotlinslackin.herokuapp.com/[Slack (3000+ users)^] 
* http://try.kotlinlang.org/[在线IDE^] 
...
* https://github.com/hexagonkt - Hexagon toolkit to develop REST services
...
* https://github.com/ice1000/NppExtension[ice1000/NppExtension^] - Notepad highlighting, including Kotlin

=== Syntax Highlighters 语法高亮
...
* https://github.com/kotlincn/[China Kotlin User Group^] - China
